...
kind_of_json_to_json("cinode-data/CompanyUser.json", "cinode-data/BetterCompanyUser.json")
kind_of_json_to_json("cinode-data/CompanyUserSkills.json", "cinode-data/BetterCompanyUserSkills.json")